        ...
        <div class="panel-body">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <h4>李雷和韩梅梅</h4><br>
                        <p style="font-size:110%">导演：</p>
                        <p style="font-size:110%">主演：</p>
                        <p style="font-size:110%">影片时长：</p>
                        <p style="font-size:110%">上映时间：</p>
                        <p style="font-size:110%">语言：</p>
