...
<head>
    ...
    <!-- Custom Fonts -->
    <link rel="stylesheet" href="../pages/font-awesome-4.4.0/css/font-awesome.min.css"  type="text/css">
...
<%
    ...
    ArrayList<Cinema> cinemaList = (ArrayList<Cinema>) request.getAttribute("CinemaList");
%>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <table class="table table-bordered">
                                ...
                                %>
                                <tr>
                                    <td><a href="<%=request.getContextPath()%>/tickets/?id=<%=film.getId()%>&cinemaId=<%=cinema.getId()%>"><%=cinema.getName()%></a></td>
